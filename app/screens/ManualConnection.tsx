...
// export class ManualConnection extends Component<{}, any> {
...
//       interface: "-1",
//       selectedDevice: null,
//       deviceList: [{ name: "No Devices", placeholder: true }],
//       sendText: "HELLO",
...
//   }
//   fillDeviceList() {
//     const getDeviceList: any = RNSerialport.getDeviceList;
...
//   }
//   devicePickerItems() {
//     const devices = this.state.deviceList.map((device, index) =>
//       !device.placeholder ? (
...
//     const select = <Picker.Item key="unknown" label="Select..." value={null} />

//     return [select].concat(devices);
//   }
...
//         Alert.alert("Please choose device");
//         return;
//       }
